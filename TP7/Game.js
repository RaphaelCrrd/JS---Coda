...
gameTest.update(backendData);
console.log("Joueurs crées dans le front :", Object.keys(gameTest.players));

console.log("Changement de PV");
let nextTickData = JSON.parse(JSON.stringify(backendData));
const player1Id = "3cd71bbb-6a6b-4d4e-80e3-107130328a27";
nextTickData.players[player1Id].hp = 80;
gameTest.update(nextTickData);
console.log(`PV de blabla : ${gameTest.players[player1Id].hp} (normalement 80)`);
